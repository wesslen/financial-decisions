...
const InstructionsMain = (props) => {
  ...
  return (
    <Container maxWidth="lg" className={classes.instructContainer}>
      ...
      <p>
        You will view data visualizations of <b>investment rates of return</b>. In each of the 12 tasks, you will view data visualizations of
          ...
          how you would <b>allocate a hypothetical investment</b> for retirement between the two
           assets as a percentage (0% to 100%).</p>
      <p>
        Your goal is to <b>maximize</b> your <b>expected return </b>
          given your allocation decision.</p>
        <p>
      ...
      <p>
        In the animation below, a user is selecting their allocation decision given the returns provided.
          They determine to put more of their investment into Asset B than Asset A.
      </p>
      <img
      ...
      />
      <p>
        In the next animation, the user decides to put their allocation near an even mix of 50% and 50%.
      </p>
      <img
      ...
      <ul>
        ...
        <li>
          In each one, you will make two allocation decisions based on
        the assets' returns with an evaluation period of either 1 year or 30 years.
        </li>
      </ul>
      <h4>Round 1</h4>
      <ul>
        <li>
          {" "}
          You'll evaluate a histogram of the assets' returns.
        </li>
        <li>You'll have <b>two allocation decisions</b> for two assets' returns in either 1 year or 30 year evaluation period.</li>
        <li>
          For each task
        </li>
      </ul>
      ...
      <ul>
        <li>{" "}
          You'll evaluate a different data visualization of the assets' returns.</li>
        <li>
          Similar to Round 1, you'll also make <b>two allocation decisions</b> on two assets' returns in either 1 year or 30 year
            evaluation periods.
        </li>
      </ul>
        <h4>Round 3</h4>
      <ul>
        <li>{" "}
            You'll evaluate the same data visualization in Round 2 but under <b>four different scenarios</b>.</li>
        <li>
          In each scenario, you will be provided your goal time horizon and required rate of return.
        </li>
      </ul>
      <div
        style={{
