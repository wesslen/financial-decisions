    ...
    questions: [
      {
        ...
        title: "What does the point and interval represent?",
        isRequired: true,
        choices: [
          "Wrong answer 1",
          "Wrong answer 2",
      ...
      <div style={{ height: "50%" }}>
        ...
        >
          ...
          <ul>
            ...
            <li>However, now you will view an <b>interval plot with a point mean</b> of the returns.</li>
            <li>
        ...
        >
          ...
          />
                                ...
                                <ul>
            <li>[Add in description and change this plot for Interval with Point]</li>
          </ul>
        </div>
