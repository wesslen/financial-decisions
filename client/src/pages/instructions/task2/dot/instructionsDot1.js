    ...
    questions: [
      {
        ...
        title: "What does each dot stand for?",
        isRequired: true,
        choices: [
          "Wrong answer 1",
          "Wrong answer 2",
      ...
      <div style={{ height: "50%" }}>
        ...
        >
          ...
          <ul>
            ...
            <li>However, now you will view a <b>quantile dot plot</b> of the returns.</li>
            <li>
        ...
        >
          ...
          />
                    <ul>
            <li>[Add in description and change this plot for Dot]</li>
          </ul>
        </div>
